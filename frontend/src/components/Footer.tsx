      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/properties?location=lagos" className="hover:text-white transition-colors">
                  Lagos
                </Link>
              </li>
              <li>
                <Link to="/properties?location=abuja" className="hover:text-white transition-colors">
                  Abuja
                </Link>
              </li>
              <li>
                <Link to="/properties?location=port-harcourt" className="hover:text-white transition-colors">
                  Port Harcourt
                </Link>
              </li>
              <li>
                <Link to="/properties?location=kano" className="hover:text-white transition-colors">
                  Kano
                </Link>
              </li>
            </ul>
