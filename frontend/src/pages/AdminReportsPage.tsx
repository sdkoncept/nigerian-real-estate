          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
            {filteredReports.length === 0 ? (
              <div className="p-12 text-center">
                ...
                <h3 className="text-xl font-semibold text-black dark:text-white mb-2">No Reports Found</h3>
                <p className="text-black dark:text-gray-300">All reports have been reviewed.</p>
              </div>
            ) : (
        ...
        {selectedReport && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full p-6">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Update Report Status</h2>
