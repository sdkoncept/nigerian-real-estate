          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-12">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">Create your account as a buyer, seller, or agent</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-sm text-gray-600">Complete verification (required for agents and property listings)</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-sm text-gray-600">Search properties or list your own</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-sm text-gray-600">Contact agents or property owners securely</p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Every property is verified to prevent scams and fake listings</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="text-2xl mr-4">✅</div>
                <div>
                  ...
                  <p className="text-gray-600">All agents are licensed and verified professionals</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="text-2xl mr-4">✅</div>
                <div>
                  ...
                  <p className="text-gray-600">Safe payment processing with Paystack integration</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="text-2xl mr-4">✅</div>
                <div>
                  ...
                  <p className="text-gray-600">All prices displayed in Nigerian Naira (₦)</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="text-2xl mr-4">✅</div>
                <div>
                  ...
                  <p className="text-gray-600">Customer support tailored for Nigerian users</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="text-2xl mr-4">✅</div>
                <div>
                  ...
                  <p className="text-gray-600">Fully responsive design works on all devices</p>
                </div>
              </div>
            </div>
          </div>
